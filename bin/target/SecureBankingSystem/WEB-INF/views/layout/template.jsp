...
<script type="text/javascript"
    src="${pageContext.request.contextPath}/resources/bootstrap/js/jquery-2.1.1.min.js"></script>
<script type="text/javascript"
...
<title><spring:message code="${titleKey}" text="sampleproject" /></title>
